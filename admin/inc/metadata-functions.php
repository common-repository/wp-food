...
function exfood_register_metabox() {
	...
	$team_info->add_field( array(
		'name'       => esc_html__( 'Custom Price', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
		'desc'       => esc_html__( 'Enter anything to replace with price', 'wp-food' ),
	...
	$addition_option = new_cmb2_box( array(
		...
		'title'         => esc_html__( 'Additional option', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
		'object_types'  => array( 'ex_food' ), // Post type
	) );
	...
	$custom_data = new_cmb2_box( array(
		...
		'title'         => esc_html__( 'Food Custom Info', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
	...
	if(exfood_get_option('exfood_rating')=='yes'){
		$rating = new_cmb2_box( array(
			'id'            => $prefix . 'rating',
			'title'         => esc_html__( 'Food rating', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
			'object_types'  => array( 'ex_food' ),
			'context'      => 'side', 
		) );
		$rating->add_field( array(
			'name'       => esc_html__( 'Rating score', 'wp-food' ),
			'desc'       => esc_html__( 'Enter from 1 to 5, ex:4.5', 'wp-food' ),
			'id'         => $prefix . 'score',
			'type'       => 'text',
			'classes'		 => '',
			'after_field'  => '',
...
function exfood_register_taxonomy_metabox() {
	...
	$cmb_term->add_field( array(
		'name' => esc_html__( 'Order Menu', 'wp-food' ),
		'id'   => $prefix .'order',
		'type' => 'text',
			'attributes' => array(
			'type' => 'number',
...
function exfood_register_setting_options() {
	...
	$main_options->add_field( array(
		'name'       => esc_html__( 'Heading Font Family', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
	...
	$main_options->add_field( array(
		'name'       => esc_html__( 'Heading Font Size', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
	...
	$main_options->add_field( array(
		'name'    => esc_html__('Heading Font Color','wp-food').'<span style="color:red"> (Only Pro version)</span>',
	...
	$main_options->add_field( array(
		'name'       => esc_html__( 'Price Font Family', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
		'desc'       => esc_html__('Enter Google font-family name. For example, if you choose "Oswald" Google Font, enter Oswald','wp-food'),
	...
	$main_options->add_field( array(
		'name'       => esc_html__( 'Price Font Size', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
	...
	$main_options->add_field( array(
		'name'    => esc_html__('Price Font Color','wp-food').'<span style="color:red"> (Only Pro version)</span>',
	...
	$main_options->add_field( array(
		'name'       => esc_html__( 'Meta Font Family', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
	...
	$main_options->add_field( array(
		'name'       => esc_html__( 'Meta Font Size', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
	...
	$main_options->add_field( array(
		'name'    => esc_html__('Meta Font Color','wp-food').'<span style="color:red"> (Only Pro version)</span>',
	...
	$main_options->add_field( array(
		...
		'desc'             => esc_html__( 'Select yes to disable link to single food page', 'wp-food' ),
	...
	$main_options->add_field( array(
		'name'             => esc_html__( 'RTL mode', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
	...
	$main_options->add_field( array(
		'name'             => esc_html__( 'Print Order', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
		'desc'             => esc_html__( 'Enable Print Order', 'wp-food' ),
		'id'               => 'exfood_enable_print',
		'type'             => 'select',
		'show_option_none' => false,
		'default' => 'no',
		'options'          => array(
			'no'   => esc_html__( 'No', 'wp-food' ),
	...
	$main_options->add_field( array(
		'name'             => esc_html__( 'Enable popup location', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
	...
	$main_options->add_field( array(
		'name'             => esc_html__( 'Popup location icon', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
	...
	$main_options->add_field( array(
		...
		'options'          => array(
			...
			'woo' => __( 'WooCommerce(Only Pro version)', 'wp-food' ),
			'disable' => __( 'Disable', 'wp-food' ),	
		),
	) );
	$main_options->add_field( array(
		'name'             => esc_html__( 'Enable admin rating', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
		'desc'             => esc_html__( 'Select yes to Enable admin rating food feature', 'wp-food' ),
		'id'               => 'exfood_rating',
		'type'             => 'select',
		'show_option_none' => false,
		'default' => '',
	...
	$adv_options->add_field( array(
		'name' => esc_html__('Email recipients','wp-food').'<span style="color:red"> (Only Pro version)</span>',
	...
	$adv_options->add_field( array(
		...
		'options'          => array(
			''   => __( 'Yes', 'wp-food' ),
			'no' => __( 'No', 'wp-food' ),
			'disable' => __( 'Disable(Only Pro version)', 'wp-food' ),
		),
	) );
	$adv_options->add_field( array(
	...
	$adv_options->add_field( array(
		'name'       => esc_html__( 'Billing Order Type required', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
		'desc'       => esc_html__( 'Select yes to make this field is required', 'wp-food' ),
		'id'         => 'exfood_ck_order_type',
		'type'             => 'select',
		'show_option_none' => false,
		'default'          => '',
		'options'          => array(
	...
	$adv_options->add_field( array(
		'name'       => esc_html__( 'Billing Location required', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
		'desc'       => esc_html__( 'Select yes to make this field is required', 'wp-food' ),
	...
	$adv_options->add_field( array(
		'name'       => esc_html__( 'Billing Store required', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
		'desc'       => esc_html__( 'Select yes to make this field is required', 'wp-food' ),
		'id'         => 'exfood_ck_store',
		'type'             => 'select',
		'show_option_none' => false,
	...
	$adv_options->add_field( array(
		'name'       => esc_html__( 'Date Delivery required', 'wp-food' ),
		'desc'       => esc_html__( 'Select yes to make this field is required', 'wp-food' ),
		'id'         => 'exfood_ck_date',
		'type'             => 'select',
		'show_option_none' => false,
	...
	$adv_options->add_field( array(
		'name'       => esc_html__( 'Disable dates', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
		'desc'       => esc_html__( 'Disable special Date Delivery', 'wp-food' ),
		'id'         => 'exfood_ck_disdate',
		'type' => 'text_date',
		'default'          => '',
		'date_format' => 'Y-m-d',
		'repeatable'     => true,
	...
	$adv_options->add_field( array(
		'name'       => esc_html__( 'Time Delivery required', 'wp-food' ),
		'desc'       => esc_html__( 'Select yes to make this field is required', 'wp-food' ),
		'id'         => 'exfood_ck_time',
		'type'             => 'select',
		'show_option_none' => false,
	...
	$adv_options->add_field( array(
		'name'       => esc_html__( 'Time option(limited 3 times)', 'wp-food' ),
		'desc'       => esc_html__( 'Add time slots for Time Delivery', 'wp-food' ),
		'id'         => 'exfood_ck_times',
		'type' => 'text',
		'repeatable'     => true,
		'show_option_none' => false,
	...
	$adv_options->add_field( array(
		'name'       => esc_html__( 'Opening and Closing time', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
		'desc'       => esc_html__( 'Select yes to enable Opening and Closing time', 'wp-food' ),
		'id'         => 'exfood_open_close',
		'type'             => 'select',
		'show_option_none' => false,
		'default'          => '',
		'options'          => array(
			'' => __( 'Disable', 'wp-food' ),
			'enable' => __( 'Enable', 'wp-food' ),
		),
		
	) );
	$adv_options->add_field( array(
		'name'       => esc_html__( 'Opening hours', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
		'id'         => 'exfood_ck_open_hour',
		'type' => 'text_time',
		'time_format' => 'H:i',
		'attributes' => array(
	...
	$adv_options->add_field( array(
		'name'       => esc_html__( 'Closing hours', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
		'id'         => 'exfood_ck_close_hour',
		'type' => 'text_time',
		'time_format' => 'H:i',
		'attributes' => array(
			'data-timepicker' => json_encode( array(
	...
	$adv_options->add_field( array(
		'name' => __( 'Minimum Order Amount required', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
		'desc'       => esc_html__( 'Set minimum amount required for each Order', 'wp-food' ),
		'id'   => 'exfood_ck_mini_amount',
		'type' => 'text',
		'sanitization_cb' => 'exfood_convert_number_to_save',
		'escape_cb'       => 'exfood_convert_number_to_show',
		'after_field'  => 'exfood_verify_money_js',
	...
	$adv_options->add_field( array(
		'name'       => esc_html__( 'Enable reCAPTCHA', 'wp-food' ).'<span style="color:red"> (Only Pro version)</span>',
	...
	$adv_options->add_field( array(
		'name' => esc_html__('reCAPTCHA Site Key','wp-food').'<span style="color:red"> (Only Pro version)</span>',
		'desc' => esc_html__('Enter google reCAPTCHA Site Key','wp-food'),
		'id'   => 'exfood_captcha_key',
		'type'        => 'text', 
	) );
	$adv_options->add_field( array(
		'name' => esc_html__('reCAPTCHA Secret Key','wp-food').'<span style="color:red"> (Only Pro version)</span>',
